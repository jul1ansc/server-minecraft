...
scoreboard objectives remove tc.break_spruce_log
scoreboard objectives remove tc.break_jungle_log
scoreboard objectives remove tc.break_birch_log
scoreboard objectives remove tc.break_crimson_stem
...
tellraw @a [{"text":"[Datapack]"},{"text":" TreeCapitator has been uninstalled","color":"green"}]