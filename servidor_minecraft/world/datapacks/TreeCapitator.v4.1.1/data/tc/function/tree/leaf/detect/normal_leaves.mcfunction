...
execute positioned ~ ~ ~1 if block ~ ~ ~ #minecraft:leaves[persistent=false] unless entity @e[type=marker,tag=TC_Leaf,distance=..0.1] if function tc:tree/leaf/check_distance summon marker if function tc:tree/leaf/marker_data run function tc:tree/leaf/detect/normal_leaves
execute positioned ~ ~ ~-1 if block ~ ~ ~ #minecraft:leaves[persistent=false] unless entity @e[type=marker,tag=TC_Leaf,distance=..0.1] if function tc:tree/leaf/check_distance summon marker if function tc:tree/leaf/marker_data run function tc:tree/leaf/detect/normal_leaves
execute positioned ~1 ~ ~ if block ~ ~ ~ #minecraft:leaves[persistent=false] unless entity @e[type=marker,tag=TC_Leaf,distance=..0.1] if function tc:tree/leaf/check_distance summon marker if function tc:tree/leaf/marker_data run function tc:tree/leaf/detect/normal_leaves
execute positioned ~-1 ~ ~ if block ~ ~ ~ #minecraft:leaves[persistent=false] unless entity @e[type=marker,tag=TC_Leaf,distance=..0.1] if function tc:tree/leaf/check_distance summon marker if function tc:tree/leaf/marker_data run function tc:tree/leaf/detect/normal_leaves
execute positioned ~ ~1 ~ if block ~ ~ ~ #minecraft:leaves[persistent=false] unless entity @e[type=marker,tag=TC_Leaf,distance=..0.1] if function tc:tree/leaf/check_distance summon marker if function tc:tree/leaf/marker_data run function tc:tree/leaf/detect/normal_leaves
